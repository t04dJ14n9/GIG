...
func TestCorrectnessCaseCoverageAudit(t *testing.T) {
	sets := []correctnessCoverageSet{
		...
		{name: "channel_pipeline", src: channelPipelineSrc, tests: []map[string]testCase{channelPipelineTests}},
		...
		{name: "select_timeout", src: selectTimeoutSrc, tests: []map[string]testCase{selectTimeoutTests}},
		...
		{name: "concurrent_stateful", src: concurrentStatefulSrc, tests: []map[string]testCase{concurrentStatefulTests}},
		{name: "cornercases_src", src: cornercasesSrcSrc, tests: []map[string]testCase{cornercasesSrcTests}},
		{name: "known_issues", src: historicalIssueSrc, tests: []map[string]testCase{knownIssuesTests}},
		...
		{name: "githublibs", src: srcGithubLibs, tests: []map[string]testCase{githubLibsTests}},
